define({ 
  ...
  onNavigate(Product){
   ...
   let noReviews = kony.i18n.getLocalizedString("NoReviews");
     this.view.LblReviewCount.text = Product.reviewList.length === 0? noReviews: this.view.LblReviewCount.text + Product.totalReviews;
...
this.view.ImgArrow.src = this.view.FlxReviews.top === '94%' ? 'downarrow.png' : 'uparrow.png';
     };
  },
